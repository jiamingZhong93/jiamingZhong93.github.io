...
<p class="intro-lead" data-zh="👋 我致力于构建在真实世界中审慎学习与行动的可信物理人工智能（Physical AI）。">👋 I’m building trustworthy Physical AI that learns and acts with caution in the real world.</p>
...
<p>学术研究之外，创业与产业经历塑造了我连接理论与实际部署的研究方式。我联合创办 <a href="https://loopx.ai/">LoopX</a>，主导自主配送与矿区运输的软件研发；在 <a href="https://reelinrobotics.ca/">Reel-In Robotics</a> 负责仓储机器人的全栈开发；在<a href="https://www.nio.com/">蔚来</a>和<a href="https://www.saicmotor.com/english/">上汽集团</a>参与量产电动汽车软件研发与版本发布。这些积累为物理人工智能的实际落地奠定基础，也有助于建立支持协同研究、联合项目申请与学生培养的合作伙伴关系。</p>
</div>
